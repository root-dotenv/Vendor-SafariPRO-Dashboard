  ...
  return (
    <div className="p-4 flex flex-col gap-y-4 text-[1.125rem]">
      ...
      <ul className="flex flex-col gap-y-4">
        ...
        <li>
          - - - - -Displays: Guests (current occupant info if available),
          Check-In & Check-Out Time (Date & Hours), Duration (calculated:
          (Check-Out - Check-In) in hrs / 24). * Admin: View. * Staff: View and
          can perform "Clear (Check) Previous Available Booked Room to make it
          Available again" action.
        </li>
        ...
        <li>
          - - - - - Displays key performance indicators (KPIs), recent activity.
        </li>
